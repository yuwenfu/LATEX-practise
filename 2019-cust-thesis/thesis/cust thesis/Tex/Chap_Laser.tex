...
\addimg{1}{guangxianfangdaqi.pdf}{几十dBm调制激光功率的多级放大器，输出功率根据放大器级数扩展}
...
\addimg{1}{laser-guangxian.pdf}{1550nm连续光纤激光器的技术文档}
...
\addimg{1}{SMF28-NA.pdf}{Corning-SMF28e+数值孔径NA}
\addimg{1}{Divergence.jpg}{光纤激光准直器的光束直径}
